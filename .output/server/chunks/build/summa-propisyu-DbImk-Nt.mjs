      ...
      if (currentResults.value.length) {
        ...
        ssrRenderList(currentResults.value, (line, idx) => {
          ...
          if (copiedText.value === line) {
            ...
            _push(`<span data-v-9e985f56>\u{1F4CB}</span>`);
          }
...
export { summaPropisyu as default };
//# sourceMappingURL=summa-propisyu-DbImk-Nt.mjs.map
