...
import { mergeProps, withCtx, createVNode, createTextVNode, useSSRContext, unref, toDisplayString } from "vue";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span class="brand-icon" role="img" aria-label="Нейронный Волк" data-v-a77c1ba2${_scopeId}>🐺</span><strong class="brand-title" data-v-a77c1ba2${_scopeId}>Сайт нейронного волка</strong>`);
      } else {
        return [
          createVNode("span", {
            class: "brand-icon",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="nw-title" data-v-ac0798a0${_scopeId}>Нейронный волк</span><span class="nw-dot" data-v-ac0798a0${_scopeId}>🐺</span><span class="nw-year" data-v-ac0798a0${_scopeId}>${ssrInterpolate(unref(year))}</span>`);
          } else {
            return [
              createVNode("span", { class: "nw-title" }, "Нейронный волк"),
              createVNode("span", { class: "nw-dot" }, "🐺"),
...
//# sourceMappingURL=MainFooter-CoPxokIq.js.map
