...
function Iterated(config){
	...
	// LABELS
	var _l1 = _makeLabel("label_they_cooperate", {x:354, y:34, rotation:45, align:"center", color:"#f5f6ff", size:15, width:70, lineHeight:1});
	self.dom.appendChild(_l1);
	var _l2 = _makeLabel("label_you_cooperate", {x:272, y:35, rotation:-45, align:"center", color:"#f5f6ff", size:15, width:70, lineHeight:1});
	self.dom.appendChild(_l2);
	var _l3 = _makeLabel("label_they_cheat", {x:406, y:86, rotation:45, align:"center", color:"#f5f6ff", size:15, width:70, lineHeight:1});
	self.dom.appendChild(_l3);
	var _l4 = _makeLabel("label_you_cheat", {x:224, y:83, rotation:-45, align:"center", color:"#f5f6ff", size:15, width:70, lineHeight:1});
...
function IteratedScoreboard(config){
	...
	left.style.color = "#f5f6ff";
	left.style.textShadow = "0 2px 8px rgba(0, 0, 0, 0.85)";
	self.dom.appendChild(left);

	// Right score
	var right = document.createElement("div");
	right.style.color = "#f5f6ff";
	right.style.textShadow = "0 2px 8px rgba(0, 0, 0, 0.85)";
