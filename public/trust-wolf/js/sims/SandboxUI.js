function SandboxUI(config){
	...
	// Labels
	page.appendChild(_makeLabel("sandbox_population", {x:0, y:0, w:433, color:"#111317", textShadow:"none"}));
	...
	******************************/
	...
	// Labels
	page.appendChild(_makeLabel("sandbox_payoffs", {x:0, y:0, w:433, color:"#111317", textShadow:"none"}));
	...
	var rule_turns = _makeLabel("sandbox_rules_1", {x:0, y:0, w:433, color:"#111317", textShadow:"none"});
	...
	var rule_evolution = _makeLabel("sandbox_rules_2", {x:0, y:100, w:433, color:"#111317", textShadow:"none"});
	...
	// Rule: Noise (0% to 50%)
	var rule_noise = _makeLabel("sandbox_rules_3", {x:0, y:225, w:433, color:"#111317", textShadow:"none"});
