...
var _configText = function(config, dom){
	...
	if(config.color!==undefined) dom.style.setProperty("color", config.color, "important");
	else dom.style.setProperty("color", "#f5f6ff", "important");
	if(config.textShadow!==undefined) dom.style.setProperty("text-shadow", config.textShadow, "important");
	else dom.style.setProperty("text-shadow", "0 2px 10px rgba(0, 0, 0, 0.85)", "important");
